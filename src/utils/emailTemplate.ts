...
<head>
    ...
    <title>Welcome to Abdal IELTS Academy</title>
    <style type="text/css">
        ...
        <table class="container" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
                <td class="content">
                    ...
                    <img src="https://i.postimg.cc/t4gnY5D5/35365870266.png" alt="Abdal IELTS Academy Logo" class="logo" />
                    ...
                    <table class="details-table">
                        <tr>
                            ...
                            <td class="value">: <a href="https://ielts-abdal.web.app/" style="color: #001f3f; font-weight: bold; text-decoration: none;">https://ielts-abdal.web.app/</a></td>
                        </tr>
                        <tr>
                            <td class="label">Student ID</td>
                            <td class="value">: ${data.studentId}</td>
                    ...
                    <div style="text-align: center;">
                        <a href="https://ielts-abdal.web.app/" class="portal-link">Access Student Portal Now</a>
                    </div>
                    ...
                    <table class="details-table">
                        ...
                        <tr>
                            ...
                            <td class="value">: abdal.ieltsacademy@gmail.com</td>
                        </tr>
                    </table>

                    <p style="margin-top: 30px; font-size: 15px; line-height: 1.6; text-align: center;">
                        We are Abdal IELTS Academy, committed to helping students achieve their target band scores through personalized coaching and structured learning programs.
                    </p>
                </td>
            </tr>
            <tr>
                <td class="footer">
                    <p>&copy; 2025 Abdal IELTS Academy. All rights reserved.</p>
